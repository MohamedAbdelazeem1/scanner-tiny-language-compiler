...
/* get the word and check it is Reserved word  , symbols  , ID ,
 *  number or comment  and store  token value and token type
 * */
void get_word( string word){

	if(word=="{"){ /* comment starting  */
		g_comment_flag=1;
	}

	else if( g_comment_flag==0){ /* if not comment enter */
